          ...
          <div class="col-12 col-md-5 col-lg-4 order-md-1 mb-auto mb-md-0 pb-8 py-md-11">
            ...
            <form class="mb-6">
              ...
              <div class="form-group">
               ...
               <!-- no WA -->
               <div class="form-group">
                <label class="form-label" for="wa">
                 Nomor Whatsapp
                </label>
                <input type="tel" class="form-control" id="wa" placeholder="Enter your whatsapp numbers">
              </div>
              <!-- Password -->
              ...
              <!-- Submit -->
              <a href="{{'/signin'}}" class="btn w-100 btn-primary" type="submit">Daftar</a>
            </form>
